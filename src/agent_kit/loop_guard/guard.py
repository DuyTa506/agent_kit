...
class LoopGuard:
    ...
    This guard is **on by default** at :class:`~agent_kit.Agent` construction
...
def evaluate_loop_guard(
    ...
    tool_blocks:
        The :class:`~agent_kit.types.ToolUseBlock` instances that were
        requested this turn.
    result_blocks:
        The :class:`~agent_kit.types.ToolResultBlock` instances produced
